...
public class CCard implements Serializable {
     ...
     * 产品规格
     */
    private CProductSize cProductSize;
    ...
    public CProductSize getcProductSize() {
        return cProductSize;
    }

    public void setcProductSize(CProductSize cProductSize) {
        this.cProductSize = cProductSize;
    }
